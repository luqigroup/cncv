...
layers = [
    ...
    "test_layers/test_layer_conv1x1_cv.jl",
    "test_layers/test_coupling_layer_basic_cv.jl",
    "test_layers/test_coupling_layer_glow_cv.jl",
    "test_layers/test_conditional_layer_glow_cv.jl",
    "test_layers/test_actnorm_cv.jl"
]

networks = [
    "test_networks/test_glow.jl",
    "test_networks/test_dense_glow.jl",
    "test_networks/test_conditional_glow_network.jl",

    "test_networks/test_glow_cv.jl",
    "test_networks/test_dense_glow_cv.jl",
    "test_networks/test_conditional_glow_network_cv.jl"
]
