"""2D Helmholtz equation solver with PML, in complex64 (single precision).

Uses complex64/float32 throughout. The adjoint gradient solve is upcast to
complex128 for accuracy (see ``adjoint_gradient``).
"""
